...
export default function Television() {
  ...
  async function repeat(prompt: string) {
    ...
    while (!done) {
      ...
      setTelevision((prev) => (prev || "") + chuckValue)
    }
  }
  ...
  async function handleSubmit(
    ...
    const personPrompt = `Generate a television suggestion for ${personName}. Their pronouns are ${personPronoun}. In a similar format to, Here's a television suggestion for ${personName} because...`
    const petPrompt = `Generate a television suggestion for ${petName} who is a pet ${petType}. In a similar format to, Here's a television suggestion for ${petName}, hope you enjoy...`
    const placePrompt = `Generate a television suggestion based on the following category and topic name. In the format, Here's a television suggestion of that genre because...\n
    Category: a place\n Topic: ${placeName}\n`
    const thingPrompt = `Suggest a television based on the following thing and it's name. In the format, Here's a television suggestion because...\n
    Category: a thing\n Topic: ${thingName}\n`
